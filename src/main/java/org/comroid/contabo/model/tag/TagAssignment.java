...
public final class TagAssignment extends ContaboModel {
    ...
    public static final VarBind<TagAssignment, String, String, String> TAG_NAME
            ...
            .build();
    public static final VarBind<TagAssignment, String, String, String> RESOURCE_TYPE // todo better parsing
    ...
    public final Ref<String> resourceType = getComputedReference(RESOURCE_TYPE);
